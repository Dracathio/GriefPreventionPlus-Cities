...
public enum Messages {
	...
	static void load() {
		...
		messages.put(Messages.CityInvitationAcceptOrReject, "&aType /c accept to accept, /c reject otherwise");
		messages.put(Messages.CityInvitationAccepted, "&aYou accepted the invitation.");
		messages.put(Messages.CityInvitationExpiresOn, "&aThis player received an invitation already (expires on: {0} seconds.)");
		...
		messages.put(Messages.CityInvitationNoPending, "&cYou have no pending invitation.");
		...
		messages.put(Messages.CitySpawnInvalid, "&cYou can't make a city spawn out of your city!");
		...
		messages.put(Messages.NoPermission, "&cYou have no permission to use this command");
		messages.put(Messages.NotAuthorized, "&cYou're not authorized.");
		messages.put(Messages.PlayerAlreadyOnAnotherCity, "&cThis player is already on another city.");
		...
		messages.put(Messages.YouAlreadyOnAnotherCity, "&cYou're already on another city");
